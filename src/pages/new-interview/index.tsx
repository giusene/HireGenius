...
import { newInterviewFormLabels, interviewFormOptions } from "@/constants/menuData";
		...
		<div className='new-interview'>
			...
			<form onSubmit={handleSubmit}>
				<div>
					...
					<Input type={"text"} name={"role"} label={newInterviewFormLabels.roleLabel} value={role} onChange={(e) => setRole(e.target.value)} />
				</div>
				<div>
