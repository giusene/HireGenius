...
import { InterviewDetails } from "@/pages/topic-process";
import { EvaluationResult } from "@/components/Organism/ResultsList/ResultsList";
...
export const saveInterviewSession = async (
  ...
  try {
    ...
    if (
      ...
      Array.isArray(userData.interviewSessions)
    ) {
